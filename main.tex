...
%----------
\graphicspath{{./images/}}
% Add Russian language and Cyrillic font encoding support
\usepackage[russian,french]{babel} % Add your main language if not french
% Example usage of Russian text:
% \begin{otherlanguage}{russian}
% Пример текста на русском языке: а (Latin), а (Cyrillic)
% \end{otherlanguage}
\begin{document}
