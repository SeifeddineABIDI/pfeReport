...
%incluye lo contenido en conclusiones.tex
    ...
    \include{netographie}
    \clearpage
    \addcontentsline{toc}{chapter}{Bibliographie} % Ajout dans la table des matières avec le nouveau titre
    \renewcommand{\bibname}{Bibliographie} % Change le titre de la section bibliographie
    \bibliographystyle{plainnat}
    \bibliography{references} % Utilise uniquement references.bib
    \clearpage
\end{document}
